...
export default function CountryPage() {
  ...
  const country = countryData.find(
    (country) => country.name.toLowerCase() === countryNameString
  );
    ...
    <div className="px-14 w-full my-32">
      <div>
        <button
          ...
          className={`${
            isDarkMode ? "bg-darkModeDb" : "bg-darkLightMode"
          } rounded-lg text-lightModeInput shadow-lg font-bold py-2 px-8 text-sm`}
        >
          Back
        </button>
      </div>
          ...
          <div className="flex gap-36">
            <div className="flex flex-col gap-y-2">
              <p className="font-bold text-[15px]">
                Native Name:{" "}
                <span className="font-normal text-lightModeInput">
                  {country?.nativeName}
                </span>
              </p>
              <p className="font-bold text-[15px]">
